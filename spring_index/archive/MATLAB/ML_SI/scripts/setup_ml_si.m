...
if check_si
    ...
    for i =1:1;%length(select6_stn_ids);
    ...
    %csvwrite('C:\Users\Jeff\Documents\MATLAB\ML_SI\data\station_1_bloom.csv', BLMTX(:,1,1));
    %csvwrite('C:\Users\Jeff\Documents\MATLAB\ML_SI\data\station_2_bloom.csv', BLMTX(:,1,2));
    %csvwrite('C:\Users\Jeff\Documents\MATLAB\ML_SI\data\station_3_bloom.csv', BLMTX(:,1,3));
    %csvwrite('C:\Users\Jeff\Documents\MATLAB\ML_SI\data\station_4_bloom.csv', BLMTX(:,1,4));
    %csvwrite('C:\Users\Jeff\Documents\MATLAB\ML_SI\data\station_5_bloom.csv', BLMTX(:,1,5));
    %csvwrite('C:\Users\Jeff\Documents\MATLAB\ML_SI\data\station_6_bloom.csv', BLMTX(:,1,6));
