...
def main():
    ...
    import_agdd(end_of_this_year, base, climate_data_provider, "alaska")
    ...
    if one_week_into_future.year != end_of_this_year.year:
        base = 32
        import_agdd(end_of_next_year, base, climate_data_provider, "conus")
        import_agdd(end_of_next_year, base, climate_data_provider, "alaska")
    ...
    if one_week_ago.year != end_of_this_year.year:
        ...
        import_agdd(end_of_previous_year, base, climate_data_provider, "alaska")
