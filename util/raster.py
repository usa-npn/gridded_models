...
def apply_alaska_mask(source_file, dest_file):
    ...
    warp_command = "gdalwarp -if GRIB -of GRIB -cutline {mask_file} -crop_to_cutline -srcnodata 9999 -dstnodata -9999 -tr .02673757 .02673757 -t_srs EPSG:4269 {source_file} {dest_file}" \
